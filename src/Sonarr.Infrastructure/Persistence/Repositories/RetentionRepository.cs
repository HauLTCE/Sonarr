...
/// <remarks>
/// Two bulk deletes rather than one statement: they hit unrelated tables, and keeping them apart
/// means one failing table does not roll back the other's work.
/// <para>Each is a single <c>DELETE … WHERE</c> over an indexed column (<c>hour_bucket</c>,
/// <c>day</c>) — the sweep must not read rows into memory on a J2900.</para>
/// </remarks>
